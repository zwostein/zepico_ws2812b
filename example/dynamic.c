...
//! [Create an instance]
	ws2812b_t ws1 = ws2812b_create( pio0, /*pin*/18, /*freq*/800000, /*size*/45, /*bufferA*/NULL, /*bufferB*/NULL );
//! [Create an instance]
	ws2812b_t ws2 = ws2812b_create( pio0, /*pin*/19, /*freq*/800000, /*size*/45, /*bufferA*/NULL, /*bufferB*/NULL );
	ws2812b_t ws3 = ws2812b_create( pio0, /*pin*/20, /*freq*/800000, /*size*/45, /*bufferA*/NULL, /*bufferB*/NULL );
	ws2812b_t ws4 = ws2812b_create( pio0, /*pin*/21, /*freq*/800000, /*size*/45, /*bufferA*/NULL, /*bufferB*/NULL );
	...
	while( true ) {
		// cycle through every led one after another
		{
			...
			for( unsigned i = 0; i < leds_size; i++ ) {
				if( i == counter/1024 % leds_size ) {
